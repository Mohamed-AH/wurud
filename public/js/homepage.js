...
(function() {
  ...
  function createSeriesCard(series, isKhutba = false) {
    ...
    const seriesUrl = series.shortId
      ? `/series/${series.shortId}${series.slug_en ? '/' + series.slug_en : ''}${series.slug_ar ? '/' + encodeURIComponent(series.slug_ar) : ''}`
      : `/series/${series.slug ? encodeURIComponent(series.slug) : series._id}`;
